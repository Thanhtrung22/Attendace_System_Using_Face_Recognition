...
class Face_Recognition:
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            #featuers = faceCascade.detectMultiScale(gray_image, scaleFactor=1.1, minNeighbors=10)
        ...
        def recognize(img,clf,faceCascade):
            ...
            #coord = draw_boundray(img, faceCascade, 1.1, 10, (255, 25, 255), clf)
        ...
        while True:
            ...
            #img = recognize(clf, faceCascade, img)
