...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Admin\Python_Test_Projects\Images_GUI\gib.png")
        ...
        #  button 2
        det_img_btn=Image.open(r"C:\Users\Admin\Python_Test_Projects\Images_GUI\fb.png")
        ...
        det_b1_1.place(x=480,y=380,width=180,height=45)
         ...
         #   button 3
        att_img_btn=Image.open(r"C:\Users\Admin\Python_Test_Projects\Images_GUI\yt.png")
        ...
        att_b1_1.place(x=710,y=380,width=180,height=45)
         ...
         #  button 4
        hlp_img_btn=Image.open(r"C:\Users\Admin\Python_Test_Projects\Images_GUI\gmail.png")
    ...
    def website(self):
        self.new = 1
        self.url = "https://github.com/Thanhtrung22"
